...
#modify by liuwei 20140725 open GMS
#BUILD_GMS=no
BUILD_GMS=yes
...
CUSTOM_HAL_IMGSENSOR=gc2155_yuv gc0328_yuv sp0a19_yuv gc0311_yuv
...
CUSTOM_HAL_MAIN_IMGSENSOR=gc2155_yuv gc0328_yuv
...
CUSTOM_HAL_SUB_IMGSENSOR=sp0a19_yuv gc0311_yuv
...
#CUSTOM_KERNEL_ALSPS=us5182_auto stk3x1x_auto
CUSTOM_KERNEL_ALSPS=stk31xx #add by maxyu 140521 for TP_PS
...
CUSTOM_KERNEL_IMGSENSOR=gc2155_yuv gc0328_yuv sp0a19_yuv gc0311_yuv
...
CUSTOM_KERNEL_MAIN_IMGSENSOR=gc2155_yuv gc0328_yuv
...
CUSTOM_KERNEL_SUB_IMGSENSOR=sp0a19_yuv gc0311_yuv
...
CUSTOM_LK_LCM=ili9488_hvga_dsi_cmd
CUSTOM_LK_LOGO=hvga
...
# lijun modify to no for camera don't show guide
MTK_APP_GUIDE=no
...
#modify by liuwei for opening BIP begin
#MTK_BIP_SCWS=no
MTK_BIP_SCWS=yes
#modify by liuwei for opening BIP end
...
# Preload 3rd party app - DeNA.
#starmen set MTK_DENA_MOBAGE_APP to no ,mobage
...
# modify by liuwei 20141110 open 3G SWITCH feature
...
#zhangguoqiang 20140901 modify MTK_IPO_SUPPORT=yes->no to close instant power on, jira DASHCMUSIC-16
MTK_IPO_SUPPORT=no
MTK_IPTV_SUPPORT=no
...
#lilong20141112 modify yes->no to set MTP as USB default mode
MTK_MASS_STORAGE=no
...
#zhangguoqiang 20140815 modify for BLU add OOBE
# lijun modify to close OOBE
#MTK_OOBE_APP=yes
MTK_OOBE_APP=yes
...
MTK_PRODUCT_AAPT_CONFIG=mdpi -sw600dp -sw720dp
...
#starmen set MTK_QQBROWSER_SUPPORT to no
...
#starmen MTK_TENCENT_MOBILE_MANAGER_SLIM_SUPPORT to no,腾讯管家
...
# lijun close the Theme function
...
#lilong 20141217 modefy MTK_USER_ROOT_SWITCH=no -> yes
...
#zhangguoqiang 20140818 add begin for The ringtone file operator assigned.
OPTR_RINGTONE_FILE = Telephone_Ring.ogg
OPTR_ALARMTONE_FILE = Alarm_clock_2.ogg
OPTR_MESSAGETONE_FILE = Msgtone.ogg
...
# lijun modify to close vice unlock
...
#starmen modify begin 20140725
#OPTR_SPEC_SEG_DEF=OP02_SPEC0200_SEGA
OPTR_SPEC_SEG_DEF=
#starmen modify end 20140725
...
#CUSTOM_MODEM=mt6572_demo_hspa_gemini
#CUSTOM_MODEM=S1123_Digicel_NoEdge_B18_Switch_Lock_Five
CUSTOM_MODEM=S1123_Digicel_NoEdge_B125_Switch_Lock
...
CUSTOM_KERNEL_LCM=ili9488_hvga_dsi_cmd
...
MTK_PRODUCT_LOCALES=en_US es_ES pt_BR zh_CN nl_NL fr_FR de_DE hu_HU cs_CZ pl_PL fa_AF fa_IR pt_PT ar_EG sr_RS bg_BG iw_IL ru_RU vi_VN hr_HR mdpi -sw600dp -sw720dp
...
#add by maxyu 140724 for 72m
MTK_SW_LCM_SUPPORT=no


#CREATE_PROJECT_INFO=20140613183438
MTK_BUILD_VERNO = ALPS.KK1.MP7.V1.7

##########################################################
# Added by shihaijun to setup software version.
# zechin internal software version.
ZX_ITL_SW_VERNO = BLU_D343L_V03_DIGICEL_GROUP
ZX_ITL_SW_VERNO_SUFFIX = B01
# Zechin hardware version
ZX_HW_VERNO = BLU_D343L_Hardware_V01
ZX_BUILD_VERNO = BLU_D343L_V03_DIGICEL_GROUP
#########################################################
#add by liuwei for fota 20140725 start
#adupsfota start
ADUPS_FOTA_SUPPORT=yes
ADUPS_FOTA_WITH_ICON=yes
ZECHIN_FOTA_PRODUCT_MODEL = DASH3.5II_D343L_DIGICEL_GROUP
ZECHIN_FOTA_VERNO = BLU_D343L_V03_DIGICEL_GROUP
#adupsfota end
#add by liuwei for fota 20140725 end
