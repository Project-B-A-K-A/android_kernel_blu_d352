...
#lilong 20140902 modefy to no for camera don't show guide
#MTK_APP_GUIDE=yes
MTK_APP_GUIDE=no
...
#starmen set MTK_TENCENT_MOBILE_MANAGER_SLIM_SUPPORT to no,腾讯管家
...
#CUSTOM_MODEM=S1123_BLU_NoEdge_B245_Switch_UnLock_Dual_HVGA_512M_256M_GPS_LESS_CRYSTAL
CUSTOM_MODEM=S1123_Digicel_NoEdge_B125_Switch_Lock_Six
...
MTK_PRODUCT_LOCALES=en_US es_ES pt_BR zh_CN nl_NL fr_FR de_DE hu_HU cs_CZ pl_PL fa_AF fa_IR pt_PT ar_EG sr_RS bg_BG iw_IL ru_RU mdpi -sw600dp -sw720dp
...
#CREATE_PROJECT_INFO=20140613184313

##########################################################
# Added by shihaijun to setup software version.
# zechin internal software version.
ZX_ITL_SW_VERNO = BLU_1123_V03
ZX_ITL_SW_VERNO_SUFFIX = B01
# Zechin hardware version
ZX_HW_VERNO = BLU_D342L_Hardware_V01
ZX_BUILD_VERNO = BLU_D342L_V03_DIGICEL
#########################################################
#add by liuwei for fota 20140725 start
#adupsfota start
ADUPS_FOTA_SUPPORT=yes
ADUPS_FOTA_WITH_ICON=yes
ZECHIN_FOTA_PRODUCT_MODEL = BLU_D342L_HVGA_NAND_DIGICEL
ZECHIN_FOTA_VERNO = BLU_D342L_V03_DIGICEL
#adupsfota end
