...
static struct LCM_setting_table lcm_initialization_setting_fwvga50_zgd_boe[] = {///added by maxyu 140805 for S2135
...
{0x42,1,{0x01}}, // VGH/VGL 
//delay_ms(1),
{0x43,1,{0x84}}, // VGH/VGL //09
//delay_ms(1),
{0x44,1,{0x8a}}, // VGH/VGL //09
//delay_ms(1),
//{0x45,1,{0x1B}},  // VGL_REG  -10V 
//{0x46,1,{0x44}},  // VGL_REG  -10V 
//{0x47,1,{0x44}},  // VGL_REG  -10V 
{0x50,1,{0x78}},   // VGMP 0x85
//delay_ms(1),
{0x51,1,{0x78}},  // VGMN 0x78
//delay_ms(1),
{0x52,1,{0x00}}, //Flicker
//delay_ms(1),
{0x53,1,{0x42}},  //0x50 //Flicker4F
//delay_ms(1),
//++++++++++++++++++ Gamma Setting ++++++++++++++++++//
...
//delay_ms(1),
{0xA2,1,{0x1F}},  // Gamma 8 /247
//delay_ms(1),
{0xA3,1,{0x14}},  // Gamma 16	/239
//delay_ms(1),
{0xA4,1,{0x0B}},  // Gamma 24 /231
//delay_ms(1),
{0xA5,1,{0x19}},  // Gamma 52 / 203
//delay_ms(1),
...
//delay_ms(1),
{0xAA,1,{0x02}}, // Gamma 203 / 52
//delay_ms(1),
{0xAB,1,{0x01}},  // Gamma 231 / 24
//delay_ms(1),
{0xAC,1,{0x0B}},  // Gamma 239 / 16
//delay_ms(1),
{0xAD,1,{0x25}},  // Gamma 247 / 8
//delay_ms(1),
{0xAE,1,{0x1F}},  // Gamma 251 / 4
//delay_ms(1),
...
//{0x06,1,{0x13}},
//delay_ms(1),
{0xFF,5,{0xFF,0x98,0x06,0x04,0x00}},     // Change to Page 7
//delay_ms(1),
...
static struct LCM_setting_table lcm_initialization_setting_fwvga45_zgd_boe[] = {///added by maxyu 140719 for S2135
...
static struct LCM_setting_table lcm_initialization_setting_fwvga45_zgd_boe_bak[] = {///added by maxyu 140719 for S2135


	{0xFF,5,{0xFF,98,06,04,01}},     // Change to Page 1
	...
	{0x62,1,{0x06}},                 // EQTI
	{0x63,1,{0x04}},                // PCTI
	{0x40,1,{0x10}},                // BT  +2/-2 pump for DDVDH-L//16
	{0x41,1,{0x22}},                 // DVDDH DVDDL clamp  
	{0x42,1,{0x30}},                 // VGH/VGL 
	{0x43,1,{0x85}},                 // VGH/VGL 
	{0x44,1,{0x8B}},                 // VGH/VGL 
	...
	{0xC5,1,{0x0B}},  // Gamma 52
	{0xC6,1,{0x06}},  // Gamma 80
	{0xC7,1,{0x03}},  // Gamma 108
	{0xC8,1,{0x0A}},  // Gamma 147
	{0xC9,1,{0x0E}},  // Gamma 175
	{0xCA,1,{0x12}},  // Gamma 203
	{0xCB,1,{0x09}},  // Gamma 231
	{0xCC,1,{0x16}},  // Gamma 239
	{0xCD,1,{0x1C}},  // Gamma 247
	...
	//****************************** Page 6 Command ******************************//
	//****************************************************************************//
	{0xFF,5,{0xFF,98,06,04,06}},     // Change to Page 6
	{0x00,1,{0x20}},
	{0x01,1,{0x05}},
	{0x02,1,{0x00}},    
	{0x03,1,{0x00}},
	...
	{0x52,1,{0x10}},
	{0x53,1,{0x10}},  //VGLO refer VGL_REG
	{0xFF,5,{0xFF,98,06,04,07}},     // Change to Page 7
	{0x18,1,{0x1D}},
	...
	{0xFF,5,{0xFF,98,06,04,00}},     // Change to Page 0
	{0x11,1,{0x00}},                 // Sleep-Out
	{REGFLAG_DELAY, 120, {}},
	{0x29,1,{0x00}},                // Display On
	{REGFLAG_DELAY, 120, {}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_active_pixel = FRAME_WIDTH;
		...
		params->dsi.PLL_CLOCK = 160;///160 173; //dsi clock customization: should config clock value directly
...
static void lcm_init(void)
{
	...
	#ifdef LCM_FWVGA50_ILI9806E_SUPPORT
	push_table(lcm_initialization_setting_fwvga50_zgd_boe, sizeof(lcm_initialization_setting_fwvga50_zgd_boe) / sizeof(struct LCM_setting_table), 1);///for S2135 FWVGA50
	#else
	push_table(lcm_initialization_setting_fwvga45_zgd_boe, sizeof(lcm_initialization_setting_fwvga45_zgd_boe) / sizeof(struct LCM_setting_table), 1);///for S2135 FWVGA45
	#endif
...
// ---------------------------------------------------------------------------
LCM_DRIVER ili9806e_dsi_vdo_fwvga_6572_drv = 
{
    .name			= "zechin_mt6572m_ili9806e_dsi_vdo_fwvga_6572",
