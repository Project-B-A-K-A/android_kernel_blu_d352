...
#define TP_PROXIMITY_SENSOR ///added by maxyu 140521 for ft6206
///#define TP_PROXIMITY_SENSOR_MSG2133A ///added by maxyu 140116 for msg2133a
...
/*----------------------------------------------------------------------------*/
#ifdef TP_PROXIMITY_SENSOR
extern unsigned char proximity_state;
#endif
...
static int stk31xx_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	#ifdef TP_PROXIMITY_SENSOR_MSG2133A
		err = -ENOMEM;
		goto exit;
	#endif
...
static int __init stk31xx_init(void)
{
	APS_FUN();
#if (LINUX_VERSION_CODE>=KERNEL_VERSION(3,0,0))	
	i2c_register_board_info(1, &i2c_stk31xx, 1);	//maxyu 130520 for tmp
#endif
