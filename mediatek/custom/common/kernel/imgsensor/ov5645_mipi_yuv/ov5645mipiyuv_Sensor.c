...
#define OV5645_TEST_PATTERN_CHECKSUM 0x6d46d8e9
...
void OV5645MIPIInitialSetting(void)
{
  ...
  OV5645MIPI_write_cmos_sensor(0x3103, 0x03);
    OV5645MIPI_write_cmos_sensor(0x3400, 0x03);// r
	OV5645MIPI_write_cmos_sensor(0x3401, 0xca); 
	OV5645MIPI_write_cmos_sensor(0x3402, 0x01);// g
	OV5645MIPI_write_cmos_sensor(0x3403, 0x00); 
	OV5645MIPI_write_cmos_sensor(0x3404, 0x01);// b
  ...
  OV5645MIPI_write_cmos_sensor(0x518a, 0x76);
...
/*
  ...
  */
  ...
  OV5645MIPI_write_cmos_sensor(0x5302, 0x30);//18
  OV5645MIPI_write_cmos_sensor(0x5303, 0x20);//08
  OV5645MIPI_write_cmos_sensor(0x5304, 0x08);
  OV5645MIPI_write_cmos_sensor(0x5305, 0x30);
  OV5645MIPI_write_cmos_sensor(0x5306, 0x08);
  OV5645MIPI_write_cmos_sensor(0x5307, 0x25);
  ...
  OV5645MIPI_write_cmos_sensor(0x5807, 0x6 );
  ...
  OV5645MIPI_write_cmos_sensor(0x5810, 0x2 );
  ...
  OV5645MIPI_write_cmos_sensor(0x5818, 0x11);
  OV5645MIPI_write_cmos_sensor(0x5819, 0x7 );
  OV5645MIPI_write_cmos_sensor(0x581a, 0x5 );
  OV5645MIPI_write_cmos_sensor(0x581b, 0x5 );
  OV5645MIPI_write_cmos_sensor(0x581c, 0x7 );
  OV5645MIPI_write_cmos_sensor(0x581d, 0xe );
  OV5645MIPI_write_cmos_sensor(0x581e, 0x2d);
  OV5645MIPI_write_cmos_sensor(0x581f, 0x1b);
  OV5645MIPI_write_cmos_sensor(0x5820, 0x12);
  OV5645MIPI_write_cmos_sensor(0x5821, 0x11);
  OV5645MIPI_write_cmos_sensor(0x5822, 0x18);
  OV5645MIPI_write_cmos_sensor(0x5823, 0x28);
  OV5645MIPI_write_cmos_sensor(0x5824, 0x24);
  OV5645MIPI_write_cmos_sensor(0x5825, 0x2e);
  OV5645MIPI_write_cmos_sensor(0x5826, 0xf );
  OV5645MIPI_write_cmos_sensor(0x5827, 0xe );
  OV5645MIPI_write_cmos_sensor(0x5828, 0x26);
  OV5645MIPI_write_cmos_sensor(0x5829, 0x2e);
  OV5645MIPI_write_cmos_sensor(0x582a, 0x2c);
  OV5645MIPI_write_cmos_sensor(0x582b, 0x2a);
  OV5645MIPI_write_cmos_sensor(0x582c, 0x2c);
  OV5645MIPI_write_cmos_sensor(0x582d, 0x2e);
  OV5645MIPI_write_cmos_sensor(0x582e, 0x2f);
  OV5645MIPI_write_cmos_sensor(0x582f, 0x26);
  OV5645MIPI_write_cmos_sensor(0x5830, 0x22);
  OV5645MIPI_write_cmos_sensor(0x5831, 0x26);
  OV5645MIPI_write_cmos_sensor(0x5832, 0x2e);
  OV5645MIPI_write_cmos_sensor(0x5833, 0x2c);
  OV5645MIPI_write_cmos_sensor(0x5834, 0x2c);
  OV5645MIPI_write_cmos_sensor(0x5835, 0x2a);
  OV5645MIPI_write_cmos_sensor(0x5836, 0x2c);
  OV5645MIPI_write_cmos_sensor(0x5837, 0x2e);
  OV5645MIPI_write_cmos_sensor(0x5838, 0x20);
  OV5645MIPI_write_cmos_sensor(0x5839, 0x2a);
  OV5645MIPI_write_cmos_sensor(0x583a, 0x2f);
  OV5645MIPI_write_cmos_sensor(0x583b, 0x2c);
  OV5645MIPI_write_cmos_sensor(0x583c, 0x22);
  OV5645MIPI_write_cmos_sensor(0x583d, 0xea);
  ...
  OV5645MIPI_write_cmos_sensor(0x3a0f, 0x36);//30
	OV5645MIPI_write_cmos_sensor(0x3a10, 0x32);//28
	OV5645MIPI_write_cmos_sensor(0x3a11, 0x71);//61
	OV5645MIPI_write_cmos_sensor(0x3a1b, 0x36);//30
	OV5645MIPI_write_cmos_sensor(0x3a1e, 0x32);//28
	OV5645MIPI_write_cmos_sensor(0x3a1f, 0x14); //10
...
static void OV5645MIPIPreviewSetting_SVGA(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x5302, 0x30);//2a
	OV5645MIPI_write_cmos_sensor(0x5303, 0x20);//1a
	OV5645MIPI_write_cmos_sensor(0x5306, 0x08);
	OV5645MIPI_write_cmos_sensor(0x5307, 0x25);
...
static void OV5645MIPIFullSizeCaptureSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x5302, 0x3f);
	OV5645MIPI_write_cmos_sensor(0x5303, 0x2f);
	OV5645MIPI_write_cmos_sensor(0x5306, 0x08);
	OV5645MIPI_write_cmos_sensor(0x5307, 0x25);
	...
	OV5645MIPI_write_cmos_sensor(0x380c, 0x0e);//0b
	OV5645MIPI_write_cmos_sensor(0x380d, 0xf0);//f0
