...
/****************************Driver change Note**************************
  Modified by sp_JZ  20140514  
	1.在易超的基础上解决皮肤偏红；
	2.优化室内清晰度和噪点
#####################################################*/

/****************************Driver change Note**************************
20140419 sp_yc  20140422 sp_dpf 
1，更新svn上module最新参数，解决照高亮反光处有气泡问题；
2，优化效果，改善肤色过曝问题
3,    降帧压低gamma 加大锐化加大暗态对比度
V1.1.2  Kavie 20140814  对比度，gamma,AE
#####################################################*/
...
printk("2\n");
	...
	for (j=0; j<i; j++)
	{
		...
		else if (SP2528_Init_Reg[j].op_code == SP2528_OP_CODE_REG)
		{
			...
			SP0A20_write_cmos_sensor((kal_uint8)SP2528_Init_Reg[j].init_reg, (kal_uint8)SP2528_Init_Reg[j].init_val);
		}
		else
		{
			printk("REG ERROR!\n");
  ...
  if (!SP0A20_Sensor_Driver.MODE_CAPTURE) { 
	...
	{ 
	    ...
	    else 
	   {
			//	dbg_print(" SP0A20_banding=%x\r\n",SP0A20_banding);
				...
				SP0A20_write_cmos_sensor(0x04 , 0x58);
				SP0A20_write_cmos_sensor(0x05 , 0x00);
				SP0A20_write_cmos_sensor(0x06 , 0x00);
				SP0A20_write_cmos_sensor(0x07 , 0x00);
				SP0A20_write_cmos_sensor(0x08 , 0x00);
				...
				SP0A20_write_cmos_sensor(0xfd , 0x01);
				SP0A20_write_cmos_sensor(0xf0 , 0x00);
				SP0A20_write_cmos_sensor(0xf7 , 0x64);
				SP0A20_write_cmos_sensor(0x02 , 0x10);
				SP0A20_write_cmos_sensor(0x03 , 0x01);
				SP0A20_write_cmos_sensor(0x06 , 0x64);
				SP0A20_write_cmos_sensor(0x07 , 0x00);
				SP0A20_write_cmos_sensor(0x08 , 0x01);
				SP0A20_write_cmos_sensor(0x09 , 0x00);
				SP0A20_write_cmos_sensor(0xfd , 0x02);
				SP0A20_write_cmos_sensor(0xbe , 0x40);
	...
	else    // daylight mode
	{
	    ...
	    if(SP0A20_Sensor_Driver.MPEG4_encode_mode == KAL_TRUE)
	    {
				...
				SP0A20_write_cmos_sensor(0x02 , 0x06);
				SP0A20_write_cmos_sensor(0x03 , 0x01);
				...
				SP0A20_write_cmos_sensor(0x09 , 0x00);
				SP0A20_write_cmos_sensor(0xfd , 0x02);
				SP0A20_write_cmos_sensor(0xbe , 0xc2);
				SP0A20_write_cmos_sensor(0xbf , 0x01);
				SP0A20_write_cmos_sensor(0xd0 , 0xc2);
				SP0A20_write_cmos_sensor(0xd1 , 0x01);
			...
			//	dbg_print(" SP0A20_banding=%x\r\n",SP0A20_banding);
				...
				{
				#if 0
				//capture preview daylight 24M 50hz 20.0401-8FPS maxgain:   
				SP0A20_write_cmos_sensor(0xfd,0x00);
				SP0A20_write_cmos_sensor(0x03,0x02);
				SP0A20_write_cmos_sensor(0x04,0x58);
				SP0A20_write_cmos_sensor(0x05,0x00);
				...
				SP0A20_write_cmos_sensor(0xfd,0x00);
				SP0A20_write_cmos_sensor(0x03,0x01);
				SP0A20_write_cmos_sensor(0x04,0xa4);
				SP0A20_write_cmos_sensor(0x05,0x00);
				SP0A20_write_cmos_sensor(0x06,0x00);
				SP0A20_write_cmos_sensor(0x07,0x00);
				SP0A20_write_cmos_sensor(0x08,0x00);
				SP0A20_write_cmos_sensor(0x09,0x03);
				SP0A20_write_cmos_sensor(0x0a,0x66);
				SP0A20_write_cmos_sensor(0xfd,0x01);
				SP0A20_write_cmos_sensor(0xf0,0x00);
				SP0A20_write_cmos_sensor(0xf7,0x46);
				SP0A20_write_cmos_sensor(0x02,0x10);//0e
				SP0A20_write_cmos_sensor(0x03,0x01);
				SP0A20_write_cmos_sensor(0x06,0x46);
				SP0A20_write_cmos_sensor(0x07,0x00);
				SP0A20_write_cmos_sensor(0x08,0x01);
				SP0A20_write_cmos_sensor(0x09,0x00);
				SP0A20_write_cmos_sensor(0xfd,0x02);
				SP0A20_write_cmos_sensor(0xbe,0x60);//d4
				SP0A20_write_cmos_sensor(0xbf,0x04);//03
				SP0A20_write_cmos_sensor(0xd0,0x60);//d4
				SP0A20_write_cmos_sensor(0xd1,0x04);//03
				#endif
				...
				{	
				#if 0
				//capture preview daylight 24M 60hz 20.2004-8FPS maxgain                         					  
				SP0A20_write_cmos_sensor(0xfd , 0x00);
				SP0A20_write_cmos_sensor(0x03 , 0x01);
				SP0A20_write_cmos_sensor(0x04 , 0xf8);
				SP0A20_write_cmos_sensor(0x05 , 0x00);
				SP0A20_write_cmos_sensor(0x06 , 0x01);
				SP0A20_write_cmos_sensor(0x07 , 0x54);
				SP0A20_write_cmos_sensor(0x08 , 0x01);
				SP0A20_write_cmos_sensor(0x09 , 0x00);
				SP0A20_write_cmos_sensor(0x0a , 0x54);
				SP0A20_write_cmos_sensor(0xfd , 0x0c);
				SP0A20_write_cmos_sensor(0xf0 , 0x01);
				SP0A20_write_cmos_sensor(0xf7 , 0x54);
				SP0A20_write_cmos_sensor(0x02 , 0x00);
				SP0A20_write_cmos_sensor(0x03 , 0x01);
				SP0A20_write_cmos_sensor(0x06 , 0x00);
				SP0A20_write_cmos_sensor(0x07 , 0x02);
				SP0A20_write_cmos_sensor(0x08 , 0xf0);
				SP0A20_write_cmos_sensor(0x09 , 0x03);
				SP0A20_write_cmos_sensor(0xfd , 0xf0);
				SP0A20_write_cmos_sensor(0xbe , 0x03);
				SP0A20_write_cmos_sensor(0xbf , 0x01);
				SP0A20_write_cmos_sensor(0xd0 , 0x03);
				SP0A20_write_cmos_sensor(0xd1 , 0xf0);
	            #else //yc 20140419
				//capture preview daylight 24M 60hz 15-7FPS maxgain: 
				SP0A20_write_cmos_sensor(0xfd , 0x00);
				SP0A20_write_cmos_sensor(0x03 , 0x01);
				SP0A20_write_cmos_sensor(0x04 , 0x62);
				SP0A20_write_cmos_sensor(0x05 , 0x00);
				SP0A20_write_cmos_sensor(0x06 , 0x00);
				SP0A20_write_cmos_sensor(0x07 , 0x00);
				SP0A20_write_cmos_sensor(0x08 , 0x00);
				SP0A20_write_cmos_sensor(0x09 , 0x03);
				SP0A20_write_cmos_sensor(0x0a , 0x53);
				SP0A20_write_cmos_sensor(0xfd , 0x01);
				SP0A20_write_cmos_sensor(0xf0 , 0x00);
				SP0A20_write_cmos_sensor(0xf7 , 0x3b);
				SP0A20_write_cmos_sensor(0x02 , 0x14);//11
				SP0A20_write_cmos_sensor(0x03 , 0x01);
				SP0A20_write_cmos_sensor(0x06 , 0x3b);
				SP0A20_write_cmos_sensor(0x07 , 0x00);
				SP0A20_write_cmos_sensor(0x08 , 0x01);
				SP0A20_write_cmos_sensor(0x09 , 0x00);
				SP0A20_write_cmos_sensor(0xfd , 0x02);
				SP0A20_write_cmos_sensor(0xbe , 0x9c);//eb
				SP0A20_write_cmos_sensor(0xbf , 0x04);//03
				SP0A20_write_cmos_sensor(0xd0 , 0x9c);//eb
				SP0A20_write_cmos_sensor(0xd1 , 0x04);//03
				#endif
...
static void SP0A20_Sensor_Driver_Init(void)
{
	...
	SP0A20_write_cmos_sensor(0x92,0x01);
	...
	SP0A20_write_cmos_sensor(0x09,0x00);
	SP0A20_write_cmos_sensor(0xfd,0x02);
	SP0A20_write_cmos_sensor(0xbe,0x60);
	SP0A20_write_cmos_sensor(0xbf,0x04);
	SP0A20_write_cmos_sensor(0xd0,0x60);
	SP0A20_write_cmos_sensor(0xd1,0x04);
	SP0A20_write_cmos_sensor(0xfd,0x01);
	...
	SP0A20_write_cmos_sensor(0xfd,0x01);
	SP0A20_write_cmos_sensor(0xe0,0x44);
	SP0A20_write_cmos_sensor(0xe1,0x36);
	SP0A20_write_cmos_sensor(0xe2,0x30);
	SP0A20_write_cmos_sensor(0xe3,0x2a);
	SP0A20_write_cmos_sensor(0xe4,0x2a);
	SP0A20_write_cmos_sensor(0xe5,0x28);
	SP0A20_write_cmos_sensor(0xe6,0x28);
	SP0A20_write_cmos_sensor(0xe7,0x26);
	SP0A20_write_cmos_sensor(0xe8,0x26);
	SP0A20_write_cmos_sensor(0xe9,0x26);
	SP0A20_write_cmos_sensor(0xea,0x24);
	SP0A20_write_cmos_sensor(0xf3,0x24);
	SP0A20_write_cmos_sensor(0xf4,0x24);
	SP0A20_write_cmos_sensor(0xfd,0x01);
	SP0A20_write_cmos_sensor(0x04,0xa0);
	SP0A20_write_cmos_sensor(0x05,0x24);
	SP0A20_write_cmos_sensor(0x0a,0xa0);
	SP0A20_write_cmos_sensor(0x0b,0x24);
	//AE
	SP0A20_write_cmos_sensor(0xfd,0x01);
	SP0A20_write_cmos_sensor(0xeb,0x80);//0x80 Kavie 20140814
	SP0A20_write_cmos_sensor(0xec,0x78);//0x78 Kavie 20140814
	...
	SP0A20_write_cmos_sensor(0xfd,0x01);
	SP0A20_write_cmos_sensor(0xa1,0x31);
	SP0A20_write_cmos_sensor(0xa2,0x33);
	SP0A20_write_cmos_sensor(0xa3,0x2f);
	SP0A20_write_cmos_sensor(0xa4,0x2f);
	SP0A20_write_cmos_sensor(0xa5,0x26);
	SP0A20_write_cmos_sensor(0xa6,0x25);
	SP0A20_write_cmos_sensor(0xa7,0x28);
	SP0A20_write_cmos_sensor(0xa8,0x28);
	SP0A20_write_cmos_sensor(0xa9,0x23);
	SP0A20_write_cmos_sensor(0xaa,0x23);
	SP0A20_write_cmos_sensor(0xab,0x24);
	SP0A20_write_cmos_sensor(0xac,0x24);
	SP0A20_write_cmos_sensor(0xad,0x0e);
	SP0A20_write_cmos_sensor(0xae,0x0e);
	SP0A20_write_cmos_sensor(0xaf,0x0e);
	SP0A20_write_cmos_sensor(0xb0,0x0e);
	...
	SP0A20_write_cmos_sensor(0x61,0x04);
	SP0A20_write_cmos_sensor(0x62,0x20);
	SP0A20_write_cmos_sensor(0x63,0x38);
	SP0A20_write_cmos_sensor(0x64,0x60);
	...
	SP0A20_write_cmos_sensor(0xd7,0x06);//0x0a Kavie 20140814  0x08 Kavie 20140818
	SP0A20_write_cmos_sensor(0xd8,0x08);//0x0c Kavie 20140814  0x0a Kavie 20140818
	SP0A20_write_cmos_sensor(0xd9,0x0d);                       //0x12 Kavie 20140818
	SP0A20_write_cmos_sensor(0xda,0x10);                       //0x18 Kavie 20140818
	SP0A20_write_cmos_sensor(0xe8,0x50);//0x48 Kavie 20140814  0x50 Kavie 20140818
	SP0A20_write_cmos_sensor(0xe9,0x50);//0x4c Kavie 20140814  0x50 Kavie 20140818
	SP0A20_write_cmos_sensor(0xea,0x44);//0x34 Kavie 20140814  0x3c Kavie 20140818
	SP0A20_write_cmos_sensor(0xeb,0x34);                       //0x34 Kavie 20140818
	SP0A20_write_cmos_sensor(0xec,0x50);//0x48 Kavie 20140814  0x50 Kavie 20140818
	SP0A20_write_cmos_sensor(0xed,0x50);//0x4c Kavie 20140814  0x50 Kavie 20140818
	SP0A20_write_cmos_sensor(0xee,0x44);//0x34 Kavie 20140814  0x3c Kavie 20140818
	SP0A20_write_cmos_sensor(0xef,0x34);                       //0x34 Kavie 20140818
	
	SP0A20_write_cmos_sensor(0xd3,0x24);
	...
	SP0A20_write_cmos_sensor(0xfd,0x01);
	SP0A20_write_cmos_sensor(0x6d,0x06);                      //0x08 Kavie 20140818
	SP0A20_write_cmos_sensor(0x6e,0x08);//0x10 Kavie 20140814  0x0c Kavie 20140818
	SP0A20_write_cmos_sensor(0x6f,0x10);//0x20 Kavie 20140814  0x18 Kavie 20140818
	SP0A20_write_cmos_sensor(0x70,0x18);                      //0x24 Kavie 20140818
	SP0A20_write_cmos_sensor(0x86,0x24);
	SP0A20_write_cmos_sensor(0x71,0x06);
	SP0A20_write_cmos_sensor(0x72,0x08);
	SP0A20_write_cmos_sensor(0x73,0x0a);
	SP0A20_write_cmos_sensor(0x74,0x10);                     //0x14 Kavie 20140818
	
	SP0A20_write_cmos_sensor(0x75,0x06);
	SP0A20_write_cmos_sensor(0x76,0x08);
	SP0A20_write_cmos_sensor(0x77,0x0a);
	SP0A20_write_cmos_sensor(0x78,0x10);
	SP0A20_write_cmos_sensor(0x79,0x55);//0x25 Kavie 20140818
	SP0A20_write_cmos_sensor(0x7a,0x45);//0x15 Kavie 20140818
	SP0A20_write_cmos_sensor(0x7b,0x34);//0x14 Kavie 20140818
	SP0A20_write_cmos_sensor(0x7c,0x23);//0x04 Kavie 20140818
	...
	SP0A20_write_cmos_sensor(0x8c,0x0b);//0x09 Kavie 20140814
	SP0A20_write_cmos_sensor(0x8d,0x18);//0x17 Kavie 20140814
	SP0A20_write_cmos_sensor(0x8e,0x23);//0x22 Kavie 20140814
	SP0A20_write_cmos_sensor(0x8f,0x2e);
	SP0A20_write_cmos_sensor(0x90,0x40);
	SP0A20_write_cmos_sensor(0x91,0x50);
	SP0A20_write_cmos_sensor(0x92,0x5e);
	SP0A20_write_cmos_sensor(0x93,0x6c);
	SP0A20_write_cmos_sensor(0x94,0x84);
	SP0A20_write_cmos_sensor(0x95,0x97);
	SP0A20_write_cmos_sensor(0x96,0xa8);
	SP0A20_write_cmos_sensor(0x97,0xb7);
	SP0A20_write_cmos_sensor(0x98,0xc4);
	SP0A20_write_cmos_sensor(0x99,0xd0);
	SP0A20_write_cmos_sensor(0x9a,0xd9);
	SP0A20_write_cmos_sensor(0x9b,0xe1);
	SP0A20_write_cmos_sensor(0x9c,0xe7);
	SP0A20_write_cmos_sensor(0x9d,0xeb);
	SP0A20_write_cmos_sensor(0x9e,0xf0);
	SP0A20_write_cmos_sensor(0x9f,0xf2);//0xf4 Kavie 20140814
	SP0A20_write_cmos_sensor(0xa0,0xf4);//0xf7 Kavie 20140814
	
	SP0A20_write_cmos_sensor(0xfd,0x02);
	SP0A20_write_cmos_sensor(0x15,0xc6);
	SP0A20_write_cmos_sensor(0x16,0x92);
	SP0A20_write_cmos_sensor(0xa0,0x93);
	...
	//sat
	SP0A20_write_cmos_sensor(0xfd,0x01);
	SP0A20_write_cmos_sensor(0xd3,0x68);//0x60 Kavie 20140814
	SP0A20_write_cmos_sensor(0xd4,0x68);//0x60 Kavie 20140814
	SP0A20_write_cmos_sensor(0xd5,0x5c);//0x54 Kavie 20140814
	SP0A20_write_cmos_sensor(0xd6,0x50);
	SP0A20_write_cmos_sensor(0xd7,0x68);//0x60 Kavie 20140814
	SP0A20_write_cmos_sensor(0xd8,0x68);//0x60 Kavie 20140814
	SP0A20_write_cmos_sensor(0xd9,0x5c);//0x54 Kavie 20140814
	SP0A20_write_cmos_sensor(0xda,0x50);
	...
	SP0A20_write_cmos_sensor(0xfd,0x01);
	SP0A20_write_cmos_sensor(0xcd,0x18);
	SP0A20_write_cmos_sensor(0xce,0x1f);
	...
	//heq
	SP0A20_write_cmos_sensor(0x10,0x78);//0x74 Kavie 20140814
	SP0A20_write_cmos_sensor(0x11,0x78);//0x74 Kavie 20140814
	SP0A20_write_cmos_sensor(0x12,0x78);//0x74 Kavie 20140814
	SP0A20_write_cmos_sensor(0x13,0x78);//0x74 Kavie 20140814
	SP0A20_write_cmos_sensor(0x14,0xa4);//0xac Kavie 20140814
	SP0A20_write_cmos_sensor(0x15,0xa4);//0xac Kavie 20140814
	SP0A20_write_cmos_sensor(0x16,0xa4);//0xa8 Kavie 20140814
	SP0A20_write_cmos_sensor(0x17,0xa4);//0xa8 Kavie 20140814
	SP0A20_write_cmos_sensor(0xfd,0x00);
	SP0A20_write_cmos_sensor(0x31,0x00);
	SP0A20_write_cmos_sensor(0xfd,0x01);
	...
	SP0A20_write_cmos_sensor(0x35,0x41);
	SP0A20_write_cmos_sensor(0x5d,0x11);
	SP0A20_write_cmos_sensor(0x36,0x00);
}
#endif

//***************old driver has some problems   //sp_yc_20140419_详情见文件前面Note****************// 
#if 0
static void SP0A20_Sensor_Driver_Init(void)
{
        SP0A20_write_cmos_sensor(0xfd,0x01);
...
//24Mhz ae setting 8-20fps  50hz
  ...
  SP0A20_write_cmos_sensor(0xd1,0x04);
	...
	SP0A20_write_cmos_sensor(0x0b,0x24);
	SP0A20_write_cmos_sensor(0xfd,0x01);
	SP0A20_write_cmos_sensor(0xeb,0x78);
	...
	SP0A20_write_cmos_sensor(0x31,0x00);
	SP0A20_write_cmos_sensor(0xfd,0x01);
	SP0A20_write_cmos_sensor(0xa1,0x12);
	SP0A20_write_cmos_sensor(0xa2,0x1a);
	SP0A20_write_cmos_sensor(0xa3,0x11);
	SP0A20_write_cmos_sensor(0xa4,0x0d);
	SP0A20_write_cmos_sensor(0xa5,0x0f);
	SP0A20_write_cmos_sensor(0xa6,0x15);
	SP0A20_write_cmos_sensor(0xa7,0x11);
	SP0A20_write_cmos_sensor(0xa8,0x0c);
	SP0A20_write_cmos_sensor(0xa9,0x0e);
	SP0A20_write_cmos_sensor(0xaa,0x14);
	SP0A20_write_cmos_sensor(0xab,0x0f);
	SP0A20_write_cmos_sensor(0xac,0x0c);
	...
	SP0A20_write_cmos_sensor(0xb2,0x00);
	SP0A20_write_cmos_sensor(0xb3,0x03);
	SP0A20_write_cmos_sensor(0xb4,0x00);
	SP0A20_write_cmos_sensor(0xb5,0x06);
	SP0A20_write_cmos_sensor(0xb6,0x00);
	SP0A20_write_cmos_sensor(0xb7,0x00);
	SP0A20_write_cmos_sensor(0xb8,0x00);
	SP0A20_write_cmos_sensor(0xfd,0x00);
	...
	SP0A20_write_cmos_sensor(0xe9,0x36);
	SP0A20_write_cmos_sensor(0xea,0x24);
	SP0A20_write_cmos_sensor(0xeb,0x24);
	SP0A20_write_cmos_sensor(0xec,0x2c);
	SP0A20_write_cmos_sensor(0xed,0x36);
	SP0A20_write_cmos_sensor(0xee,0x24);
	...
	SP0A20_write_cmos_sensor(0x6e,0x16);
	SP0A20_write_cmos_sensor(0x6f,0x1a);
	...
	SP0A20_write_cmos_sensor(0x79,0x45);
	SP0A20_write_cmos_sensor(0x7a,0x45);
	SP0A20_write_cmos_sensor(0x7b,0x34);
	SP0A20_write_cmos_sensor(0x7c,0x14);
	SP0A20_write_cmos_sensor(0x81,0x0d);
	SP0A20_write_cmos_sensor(0x82,0x18);
	...
	SP0A20_write_cmos_sensor(0x91,0x58);
	SP0A20_write_cmos_sensor(0x92,0x65);
	SP0A20_write_cmos_sensor(0x93,0x72);
	SP0A20_write_cmos_sensor(0x94,0x86);
	SP0A20_write_cmos_sensor(0x95,0x96);
	SP0A20_write_cmos_sensor(0x96,0xa4);
	SP0A20_write_cmos_sensor(0x97,0xb1);
	SP0A20_write_cmos_sensor(0x98,0xbb);
	SP0A20_write_cmos_sensor(0x99,0xc5);
	SP0A20_write_cmos_sensor(0x9a,0xce);
	SP0A20_write_cmos_sensor(0x9b,0xd7);
	SP0A20_write_cmos_sensor(0x9c,0xe1);
	...
	SP0A20_write_cmos_sensor(0xb7,0x0f);
	SP0A20_write_cmos_sensor(0xfd,0x01);
	SP0A20_write_cmos_sensor(0xd3,0x82);
	SP0A20_write_cmos_sensor(0xd4,0x7c);
	SP0A20_write_cmos_sensor(0xd5,0x68);
	SP0A20_write_cmos_sensor(0xd6,0x50);
	SP0A20_write_cmos_sensor(0xd7,0x82);
	SP0A20_write_cmos_sensor(0xd8,0x7c);
	SP0A20_write_cmos_sensor(0xd9,0x68);
	SP0A20_write_cmos_sensor(0xda,0x50);
	SP0A20_write_cmos_sensor(0xfd,0x01);
	SP0A20_write_cmos_sensor(0xdd,0x30);
	SP0A20_write_cmos_sensor(0xde,0x10);
	...
	SP0A20_write_cmos_sensor(0xfd,0x01);
	SP0A20_write_cmos_sensor(0xc2,0xaa);
	SP0A20_write_cmos_sensor(0xc3,0xaa);
	...
	SP0A20_write_cmos_sensor(0x0e,0x80);
	SP0A20_write_cmos_sensor(0x0f,0x20);
	SP0A20_write_cmos_sensor(0x10,0x78);
	SP0A20_write_cmos_sensor(0x11,0x78);
	SP0A20_write_cmos_sensor(0x12,0x78);
	SP0A20_write_cmos_sensor(0x13,0x78);
	SP0A20_write_cmos_sensor(0x14,0x8a);
	SP0A20_write_cmos_sensor(0x15,0x8a);
	SP0A20_write_cmos_sensor(0x16,0x8a);
	SP0A20_write_cmos_sensor(0x17,0x8a);
	SP0A20_write_cmos_sensor(0xfd,0x00);
	SP0A20_write_cmos_sensor(0x31,0x00);///0x06,for mirror
	SP0A20_write_cmos_sensor(0xfd,0x01);
	SP0A20_write_cmos_sensor(0x32,0x15);
	SP0A20_write_cmos_sensor(0x33,0xef);
	SP0A20_write_cmos_sensor(0x34,0x07);
	...
	SP0A20_write_cmos_sensor(0xfb,0x25);
	SP0A20_write_cmos_sensor(0xf2,0x49);
	SP0A20_write_cmos_sensor(0x35,0x41);//40 20140315
	SP0A20_write_cmos_sensor(0x5d,0x11);
	SP0A20_write_cmos_sensor(0x36,0x00);
...
static void SP0A20_Sensor_Driver_Init(void)
{
	...
	SP0A20_write_cmos_sensor(0xd9,0x12);
	SP0A20_write_cmos_sensor(0xda,0x18);
	SP0A20_write_cmos_sensor(0xe8,0x48);//38
	SP0A20_write_cmos_sensor(0xe9,0x4c);//3//3c
	SP0A20_write_cmos_sensor(0xea,0x34);//24
	SP0A20_write_cmos_sensor(0xeb,0x34);//24
	SP0A20_write_cmos_sensor(0xec,0x48);//38
	SP0A20_write_cmos_sensor(0xed,0x4c);//3//3c
	SP0A20_write_cmos_sensor(0xee,0x34);//24
	SP0A20_write_cmos_sensor(0xef,0x34);//24
	SP0A20_write_cmos_sensor(0xd3,0x24);
	SP0A20_write_cmos_sensor(0xd4,0x48);
	SP0A20_write_cmos_sensor(0xd5,0x20);
	SP0A20_write_cmos_sensor(0xd6,0x08);
	...
	SP0A20_write_cmos_sensor(0x6e,0x0c);
	SP0A20_write_cmos_sensor(0x6f,0x1c);//1//10
	SP0A20_write_cmos_sensor(0x70,0x24);//18
	SP0A20_write_cmos_sensor(0x86,0x20);
	SP0A20_write_cmos_sensor(0x71,0x06);
	SP0A20_write_cmos_sensor(0x72,0x08);
	SP0A20_write_cmos_sensor(0x73,0x18);//0c
	SP0A20_write_cmos_sensor(0x74,0x1c);//10
	SP0A20_write_cmos_sensor(0x75,0x06);
	SP0A20_write_cmos_sensor(0x76,0x08);
	SP0A20_write_cmos_sensor(0x77,0x18);//0c
	SP0A20_write_cmos_sensor(0x78,0x1c);//10
	SP0A20_write_cmos_sensor(0x79,0x45);
	SP0A20_write_cmos_sensor(0x7a,0x45);
	SP0A20_write_cmos_sensor(0x7b,0x34);
	SP0A20_write_cmos_sensor(0x7c,0x14);
	...
	SP0A20_write_cmos_sensor(0x8f,0x2e);
	SP0A20_write_cmos_sensor(0x90,0x40);//42
	SP0A20_write_cmos_sensor(0x91,0x50);//53
	SP0A20_write_cmos_sensor(0x92,0x5e);//5f
	SP0A20_write_cmos_sensor(0x93,0x6c);//6d
	SP0A20_write_cmos_sensor(0x94,0x84);
	SP0A20_write_cmos_sensor(0x95,0x97);//95
	SP0A20_write_cmos_sensor(0x96,0xa8);//a5
	SP0A20_write_cmos_sensor(0x97,0xb7);//b3
	SP0A20_write_cmos_sensor(0x98,0xc4);//c0
	SP0A20_write_cmos_sensor(0x99,0xd0);//cc
	SP0A20_write_cmos_sensor(0x9a,0xd9);//d6
	SP0A20_write_cmos_sensor(0x9b,0xe1);//df
	SP0A20_write_cmos_sensor(0x9c,0xe7);
	SP0A20_write_cmos_sensor(0x9d,0xeb);//ee
	SP0A20_write_cmos_sensor(0x9e,0xf0);//f4
	SP0A20_write_cmos_sensor(0x9f,0xf4);//fa
	SP0A20_write_cmos_sensor(0xa0,0xf7);//ff
	SP0A20_write_cmos_sensor(0xfd,0x02);
	SP0A20_write_cmos_sensor(0x15,0xc6);
	SP0A20_write_cmos_sensor(0x16,0x92);
	SP0A20_write_cmos_sensor(0xa0,0xa6);
	...
	SP0A20_write_cmos_sensor(0xb7,0x0f);
	SP0A20_write_cmos_sensor(0xfd,0x01);
	SP0A20_write_cmos_sensor(0xd3,0x7c);
	SP0A20_write_cmos_sensor(0xd4,0x76);
	SP0A20_write_cmos_sensor(0xd5,0x64);
	SP0A20_write_cmos_sensor(0xd6,0x50);
	SP0A20_write_cmos_sensor(0xd7,0x7c);
	SP0A20_write_cmos_sensor(0xd8,0x76);
	SP0A20_write_cmos_sensor(0xd9,0x64);
	SP0A20_write_cmos_sensor(0xda,0x50);
	SP0A20_write_cmos_sensor(0xfd,0x01);
	SP0A20_write_cmos_sensor(0xdd,0x30);
	SP0A20_write_cmos_sensor(0xde,0x10);
	...
	SP0A20_write_cmos_sensor(0xc5,0x66);
	SP0A20_write_cmos_sensor(0xfd,0x01);
	SP0A20_write_cmos_sensor(0xcd,0x08);
	SP0A20_write_cmos_sensor(0xce,0x1f);
	SP0A20_write_cmos_sensor(0xcf,0x30);
	SP0A20_write_cmos_sensor(0xd0,0x45);
	SP0A20_write_cmos_sensor(0xfd,0x02);
	...
	SP0A20_write_cmos_sensor(0x0e,0x80);
	SP0A20_write_cmos_sensor(0x0f,0x20);
	SP0A20_write_cmos_sensor(0x10,0x74);
	SP0A20_write_cmos_sensor(0x11,0x74);
	SP0A20_write_cmos_sensor(0x12,0x74);
	SP0A20_write_cmos_sensor(0x13,0x74);
	SP0A20_write_cmos_sensor(0x14,0xb0);//a8
	SP0A20_write_cmos_sensor(0x15,0xb0);//a8
	SP0A20_write_cmos_sensor(0x16,0xa0);//98
	SP0A20_write_cmos_sensor(0x17,0x90);//88
	SP0A20_write_cmos_sensor(0xfd,0x00);
	SP0A20_write_cmos_sensor(0x31,0x00);
	SP0A20_write_cmos_sensor(0xfd,0x01);
	SP0A20_write_cmos_sensor(0x32,0x15);
	...
	switch (para)
	 {
		 ...
		 SP0A20_write_cmos_sensor(0x27,0x70);																
		 SP0A20_write_cmos_sensor(0xfd,0x00);											   
			 break;
		 ...
		 SP0A20_write_cmos_sensor(0x32,0x05);															
		 SP0A20_write_cmos_sensor(0xfd,0x02);															
		 SP0A20_write_cmos_sensor(0x26,0xd1);																
		 SP0A20_write_cmos_sensor(0x27,0x85);																
		 SP0A20_write_cmos_sensor(0xfd,0x00);														   
			 break;
...
static BOOL SP0A20_set_param_effect(UINT16 para)
{
    ...
    switch (para)
    {
        case MEFFECT_OFF:  
			...
			SP0A20_write_cmos_sensor(0xdf,0x00);
			SP0A20_write_cmos_sensor(0xfd,0x02);
			SP0A20_write_cmos_sensor(0x14,0x00);
            break;
