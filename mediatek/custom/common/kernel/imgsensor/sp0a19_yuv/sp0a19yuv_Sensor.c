...
//#define DEBUG_SENSOR_SP0A19  //20140822 T_card_debug
		...
		else 
			{
			   //	SENSORDB(" SP0A19_banding=%x\r\n",SP0A19_banding);
				...
				//capture preview daylight 24M 50hz 20-8FPS maxgain:0x70   
					...
					SP0A19_write_cmos_sensor(0xfd,0x00);
				#else
					//capture preview daylight 24M 50hz 10-6FPS maxgain:0x70   
					SP0A19_write_cmos_sensor(0xfd,0x00);
					SP0A19_write_cmos_sensor(0x03,0x00);
				...
				//capture preview daylight 24M 60hz 20-8FPS maxgain:0x70   
					...
					SP0A19_write_cmos_sensor(0xfd,0x00);
				#else
					//capture preview daylight 24M 60hz 10-6FPS maxgain:0x70   
					SP0A19_write_cmos_sensor(0xfd,0x00);
					SP0A19_write_cmos_sensor(0x03,0x00);
					...
					SP0A19_write_cmos_sensor(0x9b,0x00);
					SP0A19_write_cmos_sensor(0xfd,0x01);
					SP0A19_write_cmos_sensor(0xce,0x5c);
					SP0A19_write_cmos_sensor(0xcf,0x03);
					SP0A19_write_cmos_sensor(0xd0,0x5c);
					SP0A19_write_cmos_sensor(0xd1,0x03);
					SP0A19_write_cmos_sensor(0xfd,0x00);
				#endif
...
//SP0A19 ini
	  SP0A19_write_cmos_sensor(0xfd,0x00);
	  SP0A19_write_cmos_sensor(0xf4,0x09);//20140812 speed
	  SP0A19_write_cmos_sensor(0xfd,0x00);
	  ...
	  SP0A19_write_cmos_sensor(0xfb,0x33); // 0x33	//0x30	sp_cgj	20140807
	  SP0A19_write_cmos_sensor(0x1f,0x08);			//0x10	sp_cgj	20140807
	  
	  
	//Blacklevel
	  SP0A19_write_cmos_sensor(0xfd,0x00);
	  SP0A19_write_cmos_sensor(0x65,0x00);//blue_suboffset	//0x06	sp_cgj	20140807
	  SP0A19_write_cmos_sensor(0x66,0x00);//red_suboffset	//0x06	sp_cgj	20140807
	  SP0A19_write_cmos_sensor(0x67,0x00);//gr_suboffset	//0x06	sp_cgj	20140807
	  SP0A19_write_cmos_sensor(0x68,0x00);//gb_suboffset	//0x06	sp_cgj	20140807
	...
	//Status
	  SP0A19_write_cmos_sensor(0xfd,0x01);
	  SP0A19_write_cmos_sensor(0xce,0xc8);//0x98 20140812
	  SP0A19_write_cmos_sensor(0xcf,0x04);
	  SP0A19_write_cmos_sensor(0xd0,0xc8);//0x98
	  SP0A19_write_cmos_sensor(0xd1,0x04); 
#else  //24M 50HZ 6-10FPS 20140823
	//ae setting
	  SP0A19_write_cmos_sensor(0xfd,0x00);
	  SP0A19_write_cmos_sensor(0x03,0x00);
	  SP0A19_write_cmos_sensor(0x04,0x99);
	...
	//smooth
	  ...
	  SP0A19_write_cmos_sensor(0x82,0x80); //raw_gflt_fac_normal	//0xe0	sp_cgj	20140807
	  ...
	  SP0A19_write_cmos_sensor(0x86,0x80); //raw_gf_fac_normal  	//0xc0	sp_cgj	20140807
	  ...
	  SP0A19_write_cmos_sensor(0x5b,0xc0);  //raw_rb_fac_normal	//0xe0	sp_cgj	20140807
	...
	//sharpen 
	  ...
	  SP0A19_write_cmos_sensor(0xe5,0x06); //rangek_neg_outdoor  //0x04	sp_cgj	20140807
	  SP0A19_write_cmos_sensor(0xd3,0x06); //rangek_pos_outdoor	//0x04	sp_cgj	20140807
	  SP0A19_write_cmos_sensor(0xd7,0x06); //range_base_outdoor	//0x04	sp_cgj	20140807
	 
	  SP0A19_write_cmos_sensor(0xe6,0x08); //rangek_neg_normal   // 0x04	sp_cgj	20140807
	  SP0A19_write_cmos_sensor(0xd4,0x08); //rangek_pos_normal   // 0x04	sp_cgj	20140807
	  SP0A19_write_cmos_sensor(0xd8,0x08); //range_base_normal   // 0x04	sp_cgj	20140807
	  ...
	  SP0A19_write_cmos_sensor(0xec,0x40);  //sharp_fac_neg_outdoor
	  SP0A19_write_cmos_sensor(0xe9,0x20);  //sharp_fac_pos_nr	  // 0x35
	  SP0A19_write_cmos_sensor(0xed,0x38);  //sharp_fac_neg_nr	//0x35	sp_cgj	20140807
	  ...
	  SP0A19_write_cmos_sensor(0xf0,0x28);  //sharp_fac_neg_low 
#if 0	  
	//CCM
	  SP0A19_write_cmos_sensor(0xfd,0x01);
	...
	//CCM	sp_cgj	20140807
	  ...
	  SP0A19_write_cmos_sensor(0xfd,0x00);  //
	   ...
	   SP0A19_write_cmos_sensor(0x95,0xB5);  // d4;B5;B5
	   SP0A19_write_cmos_sensor(0x96,0xC0);  // da;C0;C0
	   SP0A19_write_cmos_sensor(0x97,0xc8);  // e0;CA;CA
	   SP0A19_write_cmos_sensor(0x98,0xcf);  // e4;D4;D4
	   SP0A19_write_cmos_sensor(0x99,0xd3);  // e8;DD;DD
	   SP0A19_write_cmos_sensor(0x9a,0xd8);  // ec;E6;E6
	   SP0A19_write_cmos_sensor(0x9b,0xdc);  // f1;EF;EF
	   SP0A19_write_cmos_sensor(0xfd,0x01);  // 01;01;01
	   SP0A19_write_cmos_sensor(0x8d,0xe0);  // f7;F7;F7
	   SP0A19_write_cmos_sensor(0x8e,0xe2);  // ff;FF;FF	  
	   SP0A19_write_cmos_sensor(0xfd,0x00);  //
	...
	//ae target
	  SP0A19_write_cmos_sensor(0xfd,0x00); 
	  SP0A19_write_cmos_sensor(0xed,0x9c); //80 //0x8c	sp_cgj	20140807
	  SP0A19_write_cmos_sensor(0xf7,0x98); //7c //0x88	sp_cgj	20140807
	  SP0A19_write_cmos_sensor(0xf8,0x90); //70 //0x80	sp_cgj	20140807
	  SP0A19_write_cmos_sensor(0xec,0x8c); //6c //0x7c	sp_cgj	20140807 
	  
	  SP0A19_write_cmos_sensor(0xef,0x84); //99 //0x74	sp_cgj	20140807
	  SP0A19_write_cmos_sensor(0xf9,0x80); //90 //0x70	sp_cgj	20140807
	  SP0A19_write_cmos_sensor(0xfa,0x67); //80 //0x68	sp_cgj	20140807
	  SP0A19_write_cmos_sensor(0xee,0x74); //78 //0x64	sp_cgj	20140807
	...
	//lowlight lum
	  SP0A19_write_cmos_sensor(0xfd,0x00); //
	  SP0A19_write_cmos_sensor(0xb2,0x40); //lum_limit  // 0x10
	...
	//saturation
	  ...
	  SP0A19_write_cmos_sensor(0xd6,0x88); //0x78 	   (0xd7,0x60); //0x78
	  SP0A19_write_cmos_sensor(0xd7,0x88);

	//HEQ
	  SP0A19_write_cmos_sensor(0xfd,0x00); 
	  SP0A19_write_cmos_sensor(0xdc,0x00); 
	  SP0A19_write_cmos_sensor(0xdd,0x78); //0x80	sp_cgj	20140807
	  SP0A19_write_cmos_sensor(0xde,0x90); //0xa8	sp_cgj	20140807
	...
	//func enable
	  ...
	  //lingjinming add 2013 12 25
	  SP0A19_write_cmos_sensor(0xfd,0x00);
	  SP0A19_write_cmos_sensor(0x35,0x40);//或者0x35写0x00
	  //lingjinming 
}
...
UINT32 SP0A19Open(void)
{
    ...
    int retry = 3; 
	 ...
	 //lingjinming add 2013 12 24
       printk("lingjinming001 SP0A19 Sensor id read OK, ID = %x\n", sensor_id);
	//lingjinming 
	...
	//lingjinming add 2013 12 24
       printk("lingjinming002 SP0A19 Sensor id read OK, ID = %x\n", sensor_id);
	//lingjinming 
...
BOOL SP0A19_set_param_wb(UINT16 para)
{
	...
	{            
		case AWB_MODE_AUTO:
			...
			SP0A19_write_cmos_sensor(0x32,0x15);     //0x0d	sp_cgj	20140807				
            }                
		    break;
...
//	kal_uint32  ret = KAL_TRUE;
	...
	switch (para)
	{
		...
		case MEFFECT_SEPIA:
			...
			SP0A19_write_cmos_sensor(0x63, 0xa0); //0xa0 //0xa0 //0xb0 //0xc0//lwy_20140929 配合后摄调试
			SP0A19_write_cmos_sensor(0x64, 0x5a); //0x60 //0x48 //0x48 //0x20
...
UINT32 SP0A19SetTestPatternMode(kal_bool bEnable)
{
    SENSORDB("[5EA]:[SP0A19_SetTestPatternMode] Test pattern enable:%d\n", bEnable);

	if(bEnable) 
	{
		SP0A19_write_cmos_sensor(0xfd, 0x00);//page 0
		SP0A19_write_cmos_sensor(0x0d, 0x12);
	}
	else        
	{
		SP0A19_write_cmos_sensor(0xfd, 0x00);//page 0
		SP0A19_write_cmos_sensor(0x0d, 0x02);
	}    
    return ERROR_NONE;
}
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	break;
        ...
        case SENSOR_FEATURE_SET_TEST_PATTERN:
		   SP0A19SetTestPatternMode((BOOL)*pFeatureData16);
		   break;
