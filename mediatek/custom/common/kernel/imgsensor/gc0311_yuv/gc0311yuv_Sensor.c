	...
	else
	{
		...
		if(GC0311_MPEG4_encode_mode == KAL_TRUE)
			...
			GC0311_write_cmos_sensor(0x33, 0x20);
           	       GC0311_write_cmos_sensor(0xfe, 0x00);
			GC0311GammaSelect(GC0311_RGB_Gamma_m5);
...
void GC0311_Sensor_Init(void)
{
	...
	GC0311_write_cmos_sensor(0x08, 0x70);
	GC0311_SET_PAGE1;
	...
	GC0311_write_cmos_sensor(0x2c, 0x58);
	...
	GC0311_SET_PAGE0;
 /////////////////20120703//////////////////////////
	GC0311_write_cmos_sensor(0x77, 0x50); // 0x7c
	GC0311_write_cmos_sensor(0x78, 0x40);
	GC0311_write_cmos_sensor(0x79, 0x56);
  /////////////////20120703//////////////////////////
	GC0311_write_cmos_sensor(0x17, 0x14);///0x14,0x17[for WW805_VK]
	...
	GC0311_write_cmos_sensor(0x46, 0x06);//0x02
	...
	GC0311_write_cmos_sensor(0x84, 0x02);//0x02
	...
	GC0311_write_cmos_sensor(0x95, 0x43);
	...
	GC0311_write_cmos_sensor(0x13, 0x82);
	...
	GC0311_write_cmos_sensor(0x22, 0x60);
	...
	GC0311_write_cmos_sensor(0x50, 0xf5);
	GC0311_write_cmos_sensor(0x51, 0x05);
	GC0311_write_cmos_sensor(0x52, 0x14);
	GC0311_write_cmos_sensor(0x53, 0x08);
	GC0311_write_cmos_sensor(0x54, 0x04);//18  1122
	GC0311_write_cmos_sensor(0x55, 0x30); //30
	GC0311_write_cmos_sensor(0x56, 0x30);
	GC0311_write_cmos_sensor(0x57, 0x18);
	...
	GC0311_write_cmos_sensor(0x6d, 0x24);
	GC0311_write_cmos_sensor(0x6e, 0x20);
	...
	GC0311_write_cmos_sensor(0x81, 0x78);
	GC0311_write_cmos_sensor(0x82, 0x60);
	GC0311_write_cmos_sensor(0x83, 0x6b);  //70  1122
...
////////////////20120613 start//////////////////////////
	...
	GC0311_write_cmos_sensor(0x95, 0x77);

	GC0311_write_cmos_sensor(0xd1, 0x28);
	GC0311_write_cmos_sensor(0xd2, 0x28);
	GC0311_write_cmos_sensor(0xd3, 0x42);
	///YUV maxtrix////
	GC0311_write_cmos_sensor(0xb0, 0x14);
       GC0311_write_cmos_sensor(0xb1, 0x20);//26   1122
	GC0311_write_cmos_sensor(0xb2, 0x0d);//07
	GC0311_write_cmos_sensor(0xb3, 0xf9);
	GC0311_write_cmos_sensor(0xb4, 0xeb);//ea
	GC0311_write_cmos_sensor(0xb5, 0x1c); //21
	GC0311_write_cmos_sensor(0xb6, 0x22);//21
	GC0311_write_cmos_sensor(0xb7, 0xe3);//e5
	GC0311_write_cmos_sensor(0xb8, 0xfb);//fb
        ...
        MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    pSensorInfo->PreviewDelayFrame = 6; //5
...
BOOL GC0311_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0311_write_cmos_sensor(0x2e, 0xee);
			GC0311_write_cmos_sensor(0x2f, 0x03);   //exp level 0  10.00fps
			GC0311_write_cmos_sensor(0x30, 0x84);
...
#define GC0311_TEST_PATTERN_CHECKSUM 0x1e0cd19f // 

UINT32 GC0311SetTestPatternMode(kal_bool bEnable)
{
    printk("[GC0311SetTestPatternMode] Test pattern enable:%d\n", bEnable);
	if(bEnable)    // enable test pattern output  0809 ok!!!
	{
	 ...
	 GC0311_write_cmos_sensor(0x18, 0x06); 
	 ...
	 GC0311_write_cmos_sensor(0xdd, 0x00); 
        GC0311_write_cmos_sensor(0x71, 0x40); 
        GC0311_write_cmos_sensor(0x72, 0x40); 
        GC0311_write_cmos_sensor(0x03, 0x00); 
        GC0311_write_cmos_sensor(0x04, 0x00); 

        GC0311_write_cmos_sensor(0x4c, 0x01); // 0x11
