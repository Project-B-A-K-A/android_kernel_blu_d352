...
#starmen add begin for copy image 20140725
ifeq ($(ACTION),)
	$(hide) echo $(SHOWTIME) "Copy image to Release folder"
	$(hide) $(MKTOPDIR)/autoCopy "$(ZX_ITL_SW_VERNO)$(ZX_ITL_SW_VERNO_SUFFIX)" "$(PROJECT)"
endif
#starmen add end for copy image 20140725
